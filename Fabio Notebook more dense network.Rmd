...
# Calculate the number of cores for paralized process
...
```{r c-vec-distribution, fig.cap="noch als ECCDF einfügen"}
...
Computing the raw DF-estimate (renormalized but without further MLE iterations) takes for this toyworld and the specified configurations ca. `r paste(round(DF.raw.time + (MLE.time[[3]] / n.iter.MLE), 0))` seconds.
